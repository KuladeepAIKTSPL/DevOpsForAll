    ...
    <footer className="bg-dark-card border-t border-gray-800 py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-400">
        <div className="flex justify-center space-x-6 mb-4">
          <a href="#" className="hover:text-neon-blue transition-colors"><https://github.com/KuladeepAIKTSPL/DevOpsForAll /></a>
        ...
        <p className="text-sm mt-2">Built by Aikshetra Tech</p>
      </div>
    </footer>
  );
};
